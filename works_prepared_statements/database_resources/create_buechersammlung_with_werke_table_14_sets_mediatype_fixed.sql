...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 27. Aug 2023 um 18:54
...
--
CREATE DATABASE IF NOT EXISTS `buechersammlung` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `buechersammlung`;
...
(4, 'Prinzessin Fiona', 'Das Schloss hinter dem Drachen', '2021', 'Hörbuch', 15.99),
